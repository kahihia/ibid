...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bidding_prepromotedauction', (
        ...
        db.send_create_signal('bidding', ['PrePromotedAuction'])

        # Adding model 'PromotedAuction'
        db.create_table('bidding_promotedauction', (
            ('auction_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bidding.Auction'], unique=True, primary_key=True)),
            ('promoter', self.gf('django.db.models.fields.related.ForeignKey')(related_name='promoter_user', to=orm['bidding.Member'])),
        ))
        db.send_create_signal('bidding', ['PromotedAuction'])


    def backwards(self, orm):
        # Deleting model 'PrePromotedAuction'
        db.delete_table('bidding_prepromotedauction')

        # Deleting model 'PromotedAuction'
        db.delete_table('bidding_promotedauction')
    ...
    models = {
        ...
        'bidding.promotedauction': {
            'Meta': {'ordering': "['-id']", 'object_name': 'PromotedAuction', '_ormbases': ['bidding.Auction']},
            'auction_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['bidding.Auction']", 'unique': 'True', 'primary_key': 'True'}),
            'promoter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'promoter_user'", 'to': "orm['bidding.Member']"})
        },
