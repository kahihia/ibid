...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'bidding_templateauction')

        # Deleting model 'AuctionFixture'
        db.delete_table(u'bidding_auctionfixture')

        # Adding field 'Auction.always_alive'
        db.add_column(u'bidding_auction', 'always_alive',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'bidding_templateauction', (
        ...
        db.send_create_signal(u'bidding', ['TemplateAuction'])

        # Adding model 'AuctionFixture'
        db.create_table(u'bidding_auctionfixture', (
        ...
        db.send_create_signal(u'bidding', ['AuctionFixture'])

        # Deleting field 'Auction.always_alive'
        db.delete_column(u'bidding_auction', 'always_alive')
