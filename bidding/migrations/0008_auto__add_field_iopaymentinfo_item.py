...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IOPaymentInfo.item'
        db.add_column(u'bidding_iopaymentinfo', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bidding.Item'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'IOPaymentInfo.item'
        db.delete_column(u'bidding_iopaymentinfo', 'item_id')
    ...
    models = {
        ...
        u'bidding.iopaymentinfo': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bidding.Item']", 'null': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bidding.Member']"}),
