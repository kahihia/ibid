...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FBOrderInfo.quantity'
        db.add_column(u'bidding_fborderinfo', 'quantity',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FBOrderInfo.quantity'
        db.delete_column(u'bidding_fborderinfo', 'quantity')
