...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for member in orm['bidding.Member'].objects.all():
            member.password=member.user.password
            member.username=member.user.username
            member.email=member.user.email
            member.is_superuser=member.user.is_superuser
            member.is_staff=member.user.is_staff
            member.last_login=member.user.last_login
