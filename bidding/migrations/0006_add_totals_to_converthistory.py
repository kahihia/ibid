...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConvertHistory.total_tokens'
        db.add_column('bidding_converthistory', 'total_tokens',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ConvertHistory.total_bids'
        db.add_column('bidding_converthistory', 'total_bids',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ConvertHistory.total_bidsto'
        db.add_column('bidding_converthistory', 'total_bidsto',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ConvertHistory.total_tokens'
        db.delete_column('bidding_converthistory', 'total_tokens')

        # Deleting field 'ConvertHistory.total_bids'
        db.delete_column('bidding_converthistory', 'total_bids')

        # Deleting field 'ConvertHistory.total_bidsto'
        db.delete_column('bidding_converthistory', 'total_bidsto')
