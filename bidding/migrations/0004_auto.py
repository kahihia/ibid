...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'bidding_auction_categories')
        ...
        db.create_unique(m2m_table_name, ['auction_id', 'category_id'])


    def backwards(self, orm):
        # Removing M2M table for field categories on 'Auction'
        db.delete_table(db.shorten_name(u'bidding_auction_categories'))
