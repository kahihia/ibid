...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConfigKey.description'
        db.add_column(u'bidding_configkey', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ConfigKey.value_type'
        db.add_column(u'bidding_configkey', 'value_type',
                      self.gf('django.db.models.fields.CharField')(default='int', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConfigKey.description'
        db.delete_column(u'bidding_configkey', 'description')

        # Deleting field 'ConfigKey.value_type'
        db.delete_column(u'bidding_configkey', 'value_type')
