...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bidding_paypalpaymentinfo', 'transaction_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=19))
        # Adding index on 'PaypalPaymentInfo', fields ['transaction_id']
        db.create_index(u'bidding_paypalpaymentinfo', ['transaction_id'])


    def backwards(self, orm):
        # Removing index on 'PaypalPaymentInfo', fields ['transaction_id']
        db.delete_index(u'bidding_paypalpaymentinfo', ['transaction_id'])
    ...
    models = {
        ...
        u'bidding.paypalpaymentinfo': {
            ...
            'purchase_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'quantity': ('django.db.models.fields.IntegerField', [], {}),
            'transaction_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '19', 'db_index': 'True'})
        },
