...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConvertHistory.bids_amount'
        db.alter_column('bidding_converthistory', 'bids_amount', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ConvertHistory.tokens_amount'
        db.alter_column('bidding_converthistory', 'tokens_amount', self.gf('django.db.models.fields.IntegerField')(null=True))
    def backwards(self, orm):

        # Changing field 'ConvertHistory.bids_amount'
        db.alter_column('bidding_converthistory', 'bids_amount', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'ConvertHistory.tokens_amount'
        db.alter_column('bidding_converthistory', 'tokens_amount', self.gf('django.db.models.fields.IntegerField')(default=0))
    models = {
        'auth.group': {
