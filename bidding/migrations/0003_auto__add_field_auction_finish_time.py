...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Auction.finish_time'
        db.add_column(u'bidding_auction', 'finish_time',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Auction.finish_time'
        db.delete_column(u'bidding_auction', 'finish_time')
