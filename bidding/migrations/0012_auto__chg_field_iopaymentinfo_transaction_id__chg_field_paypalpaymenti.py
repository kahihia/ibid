...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bidding_paypalpaymentinfo', 'transaction_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'IOPaymentInfo.transaction_id'
        db.alter_column(u'bidding_iopaymentinfo', 'transaction_id', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))
