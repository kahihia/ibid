...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('bidding_converthistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bidder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bidding.Member'])),
            ('tokens_amount', self.gf('django.db.models.fields.IntegerField')()),
            ('bids_amount', self.gf('django.db.models.fields.IntegerField')()),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('bidding', ['ConvertHistory'])

    def backwards(self, orm):
        # Deleting model 'ConvertHistory'
        db.delete_table('bidding_converthistory')
    ...
    models = {
        ...
        'bidding.converthistory': {
            ...
            'bidder': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bidding.Member']"}),
            'bids_amount': ('django.db.models.fields.IntegerField', [], {}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tokens_amount': ('django.db.models.fields.IntegerField', [], {})
        },
        'bidding.item': {
