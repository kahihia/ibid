...
class PrecapAuctionDelegate(StateAuctionDelegate):
    ...
    def completion(self):
        ...
        #return int(100 - 100 * self.auction._precap_bids_needed() / self.auction.precap_bids)
...
class RunningAuctionDelegate(StateAuctionDelegate):
    ...
    def pause(self):
        ...
        #from bidding.tasks import FinishAuctionTask, ResumeAuctionTask
        #revokes finish task
        ...
        #ResumeAuctionTask.apply_async(args=[self.auction.id], countdown=15)
