...
FACEBOOK_REGISTRATION_BACKEND = 'ibidgames.authbackends.YambidRegistration'
...
INTERNAL_IPS = ('10.178.68.177','10.178.67.67')
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file':{
                ...
                'formatter': 'verbose',
                'filename': '/var/apps/apps.facebook.ibidgames.com/logs/ibiddjango.log',
                'maxBytes': 1024000,
                'backupCount': 3,
        },
        'sql':{
            'class' : 'logging.handlers.RotatingFileHandler',
            'formatter': 'verbose',
            'filename': '/var/apps/apps.facebook.ibidgames.com/logs/yambid_sql.log',
            'maxBytes': 102400,
            'backupCount': 3,
            },
        'commands':{
                'class' : 'logging.handlers.RotatingFileHandler',
                'formatter': 'verbose',
                'filename': '/var/apps/apps.facebook.ibidgames.com/logs/commands.log',
                'maxBytes': 10240,
                'backupCount': 3,
        },
...
IMAGES_SITE = 'http://dev.facebook.ibidgames.com/' #'http://apps.facebook.com/interactivebids'
...
NOT_AUTHORIZED_PAGE = "http://apps.facebook.com/ibidgame-dev"
FBAPP_HOME = "http://apps.facebook.com/ibidgames-dev/home"
CANVAS_HOME = "http://apps.facebook.com/ibidgames-dev/canvashome/"
