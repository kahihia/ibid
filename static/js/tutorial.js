...
function initTutorial(){
    ...
    jQuery('#tutorial-dialog').bind('tutorialEvent11', function(e){displayTutorial(    {img:tutorialImages.slide12,  prevEvent:'tutorialEvent10',  nextEvent:'tutorialEventFinish'});});
